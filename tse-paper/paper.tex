...
\newcommand{\tinyish}{\fontsize{6.5pt}{6.15pt}\selectfont}
...
\author{Carolin~E.~Brandt, %~\IEEEmembership{Member,~IEEE,}
        Moritz~Beller%~\IEEEmembership{Fellow,~OSA,}% <-this % stops a space
...
\thanks{Manuscript received May 1, 2020; revised August 26, 2015.}}
...
use which technique.
We close with a roadmap of important open problems in the
emerging field of
build log analysis.
\end{abstract}
...
\begin{IEEEkeywords}
Build Log Analysis, Chunk Retrieval, Continuous Integration
\end{IEEEkeywords}}
...
\begin{IEEEbiography}{Carolin E. Brandt}
Biography text here.
\end{IEEEbiography}

\begin{IEEEbiography}{Moritz Beller}
Biography text here.
\end{IEEEbiography}
