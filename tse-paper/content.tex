...
\subsection{Continuous Integration and Build Logs}
...
\subsubsection{Build Failures in CI}
...
\subsubsection{Supporting Log Analysis with Chunk Retrieval}
...
\subsubsection{Example of Using the Recommendation Scheme}
...
\subsection{Few Samples with Many Structural Categories}
