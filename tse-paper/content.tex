...
% TODO Caro: check article vs.
work occurrences, balance use
...
% C: this (to be 4b) is closer to 4a, therefore I moved it up
% and the use/purpose down (to be 4c then)
...
% TODO Caro: test \emph{parser}, regex, manually, etc...
...
In summary, the outcome of the literature survey show the need for
build log
...
In this section, we define our notion of chunk
...
real-world build logs in \Cref{lst:logexamples}.
