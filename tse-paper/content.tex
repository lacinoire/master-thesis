...
one search query.
We automatically removed all duplicates and were
...
working with build logs, we included them in our survey. In total, we
...
In this pass we further identified x duplicate articles % TODO: {do we push
% those to the last pass?}.
...
technique. We start with CTS, KWS and RLR, as their results are easiest to
understand.
...
\begin{subfigure}[t]{\columnwidth}
		...
		\caption{Compared with the number of structural categories in the
...
\begin{subfigure}[b]{\columnwidth}
		...
		clip]{img/big-study/failure-reason-categorycount-PBE.pdf}
				\caption{Successfulness of retrieval compared with the number of
