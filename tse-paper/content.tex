...
\begin{figure}[tbp]
		...
		clip]{img/lit-sur/techniques.pdf}
		\caption{Frequency of different technique labels for
		labels $>1$ occurence.}
		\label{fig:litsur:techniques}
\end{figure}
...
\begin{figure}[tbp]
		...
		\caption{Frequency of different targeted information
		labels for
		labels $>1$ occurence.}
...
\begin{figure}[tbp]
		...
		\caption{Frequency of different usage of output labels for
		labels $>1$ occurence.}
...
\begin{figure}[tbp]
		\centering
		\includegraphics[width=\columnwidth,
		clip]{img/lit-sur/log_producer.pdf}
		\caption{Frequency of different log producer labels for
		labels $>1$ occurence.}
