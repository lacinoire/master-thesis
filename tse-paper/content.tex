...
language
processing (NLP, see \Cref{tab:litsur:techniques}), we leverage widely-used text similarity measures and call this approach \emph{Common Text Similarity (CTS)}.
...
that appear in the example logs, where we separate words by spaces and
punctuation.
