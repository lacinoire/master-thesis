...
\begin{itemize}[leftmargin=1.2cm]
  \item[\textbf{RQ2.1:}] With how many examples does a technique
  perform best?
  \item[\textbf{RQ2.2:}] How structurally variable can configuration
  examples be?
...
analysis and evaluted them informally.
...
% TODO This does not add up to 1.
Please no decimals,
% we do not need so much precision here.
Also tell % of what?
...
recall (70\%, KWS).
Overall, all technqiues vastly outperformed a
