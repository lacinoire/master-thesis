...
\\
Manual inspection  &
\cite{sulir2016quantitative,hassan2017automatic,bouabana2019theory,barinov2017applying,silva2018build,ghaleb2019empirical,marcozzi2019systematic,hukkanen2015adopting,rausch2017empirical,hassan2017mining,zolfagharinia2019study,cassee2019impact}
&
...
% TODO: PIT tool, often: much variety in log format only time for
one parser
...
to the researchers.
% TODO cite 'Autmoated localization for unreproducible builds
...
the logs
only restrict their work to few logs or take a ``representative sample to
make manual analysis feasible''.
% TODO cite: a study of build inflation in 30 mil CPAN builds
...
% TODO Caro: integrate as anecdotes in lit results
...
% TODO: Caro: integrate into pbe description
