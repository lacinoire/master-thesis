...
contextual information Google Scholar displayed. Our strategy was to
err on the side of caution, that is rather including a paper than
not. We then unified the search results, removing duplicates. After
this process, we were left with 271 (17\%) of the original search
results.
...
\Cref{fig:success-partial-all} compares the success of all chunk retrieval by the different techniques in our study.
