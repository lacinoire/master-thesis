...
% when we argue about this later we leave out the middle so A and B
% match.
whe then say that the long tail benefits from the generic
% solution.
Yes all benefit, but I think it's simpler like this.
\begin{figure}[tbhp]
		\centering
...
\begin{itemize}[leftmargin=0.4cm] \itemsep1em
	...
	technique as well as the chnuk defined in the
  test example.
