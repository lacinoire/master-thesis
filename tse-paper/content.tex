...
1}}
What are the state-of-the-research techniques for build log analysis?
\end{simplebox}

In this article, as the first step (\Cref{fig:overview}), we show that
...
To enable the retracing of our research, we provide a detailed replication
...
The main difference between build logs
...
We refined our search criteria to exclude obvious
non-related works.
...
If one of the articles referenced a new article in the context
...
In several cases, multiple articles were extensions of others.
...
techniques for build log analysis?}
...
Based on the search strings they create a script that automatically
classifies the remaining logs.

25\% of the articles claimed their implementation is available,
however, we
saw a very low reuse of build log analysis tools within our survey.
...
The majority of articles (42\%) targeted logs from a source that was not
