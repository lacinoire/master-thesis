...
% C: run vs apply / show 332 heading / maybe take only run
...
% C: text similarity and three letter acronyms
...
% M: but wait, this is not really true for KWS, right?
% TODO Moritz: C: sure it is.

% for KWS we vary the number of lines we extract around a found word
...
% TODO: can we say 'training examples' in 22?
...
% C: are you talking about the following or the previous paragraph?
% the following one is a more explicit definition of 'example' as
% used in the study

% TODO couldn't it also be chunks? why corresponding?
% C: you took that out already? a (maybe unecessary) specification
% it is always ONE chunk !
...
% C: see discussion further above about run vs apply
% if we adapt the headings (332 and so on) we can use run
...
on which Microsoft details how its CI service, Azure Pipes, uses a
...
% TODO check resolved: Also tell % of what?
