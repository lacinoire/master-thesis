...
% rather broken and itemish anyways
...
\begin{itemize}
	...
	\item inspired by the manual adhoc-search for key parts in the
	log, a
...
% inspired by the manual adhoc-search for key parts in the log, a
% technique employing \emph{Keyword Search (KWS)}.
...
=== RUN   TestSeparator
  ...
  \begin{lstlisting}[breaklines=true,frame=lr]
...
\caption{Examplary log excerpts.}
...
% or too much 'foreshadowing' too far down in the hierachy
