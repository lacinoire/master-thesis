...
% TODO Caro: The following is very obvious and could apply to any
% technique. 
\subsubsection{Application}
...
\begin{itemize}[leftmargin=0.4cm] \itemsep1em
	...
	\mathit{RetrievedLines}$ \vspace{0.2cm}\\
        ...
        example. 
        % TODO (Caro) What about when a line is replicated twice?
        % I.e., Are line numbers part of this?
...
% TODO Caro: Please explain the following further. Why does a
% realistic data set only have one or few structural categories?
...
\begin{itemize}
  ...
  \emph{LogChunks} data set \cite{} specifically for the comparative
