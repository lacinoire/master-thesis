...
class Optparser
  def self.parse(args)
    ...
    opt_parser = OptionParser.new do |opts|
      ...
      opts.separator '       ruby run-extraction.rb -a evaluate -t <technique: ir, pbe, keyword, random> -e <example_set> -s <selection_technique> -l <step_count_for_learning> -c <test_count>'
