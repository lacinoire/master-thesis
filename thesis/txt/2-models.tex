...
\begin{itemize}
	...
	\item \textbf{TravisExitCode} Travis CI prints all exit codes of commands.
	      ...
	      Figure~\ref{fig:log-3} shows an example of an TravisExitCode instantiation within a build log.
...
\begin{figure}[htbp]
	...
	\caption{Excerpt from a build log showing textual representations of a long TravisWorker instantiation and a TravisSystemInfo}
	\label{fig:log-0}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth, clip]{img/log12.png}
	\caption{Excerpt from a build log showing textual representations of a TravisTiming and a TravisPhase, containing the TravisPhaseName and the TravisPhaseOutput}
	\label{fig:log-1}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth, clip]{img/log22.png}
	\caption{Excerpt from a build log showing the textual representation of a short TravisWorker}
	\label{fig:log-2}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth, clip]{img/log32.png}
	\caption{Excerpt from a build log showing textual representations of an ErrorMessage, an ExitCode and a TravisTriggeringCommand}
	\label{fig:log-3}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth, clip]{img/log42.png}
	\caption{Excerpt from a build log showing the textual representation of a WarningMessage}
	\label{fig:log-4}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth, clip]{img/log52.png}
	\caption{Excerpt from a build log showing the textual representation of another WarningMessage}
	\label{fig:log-5}
\end{figure}
...
\label{sec:expl-rlr}
There are further build log analysis techniques mentioned in literature and used in industry.
