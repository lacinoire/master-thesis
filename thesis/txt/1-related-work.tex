...
\begin{itemize}
  \item is \textbf{implicit}, as we do not have access to explicit structuring elements or an explicit structure description and computation is required to obtain the structure which is present.
  \item is \textbf{irregular}, as changes in the build process or execution environment might change it without notice.
