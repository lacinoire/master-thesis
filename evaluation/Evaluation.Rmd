...
data <- getDataFrameForResultsFile("android-failure-with-dependencies_ChronologicalSelection.xml")
...
p <- ggplot(data = plot_data, aes(x = plot_data$ExampleCount, y = plot_data$ApplicationDuration)) + 
  ...
  labs(subtitle="", 
       ...
       x="example count", 
       title="Scatterplot", 
       caption = "android-failure chronological example selection") +
...
ggsave("android-chronological.png", p) ## TODO make work
plot(p)
```